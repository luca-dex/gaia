...
menuElenchiVolontari(
    "Iscritti per Corso Base",
    "?p=admin.utenti.excel&iscritti",
    "?p=utente.mail.nuova&iscritti"
);
...
<?php if ( isset($_GET['ok']) ) { ?>
    <div class="alert alert-success">
        <i class="icon-save"></i> <strong>Iscritto eliminato</strong>.
        L'Iscritto è stato eliminato con successo.
    </div>
...
<?php }elseif ( isset($_GET['gia']) )  { ?>
    <div class="alert alert-block alert-error">
        <h4><i class="icon-warning-sign"></i> L'aspirante risulta già iscritto</h4>
        <p>L'aspirante che hai selezionato risulta già iscritto ad un corso base.</p>
    </div>
